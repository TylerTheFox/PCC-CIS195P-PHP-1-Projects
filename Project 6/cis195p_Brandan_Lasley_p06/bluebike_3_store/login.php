	...
	<div id="content">
		<form action="logincheck.php" method="post">
			<table class="leftBox">
				<tbody>
					<tr>
						<td> <?PHP echo($TEXT['rnm-reg-txt-0']); ?> </td>
						<td><input class="data" name="loginid" value="Brandan" type="text" /></td>
					</tr>
					<tr>
						<td> <?PHP echo($TEXT['rnm-reg-txt-1']); ?> </td>
						<td><input class="data" name="password" value="supersecret" type="password" /></td>
					</tr>
					<tr>
						<td colspan="2" class="login"> <input value="<?PHP echo($TEXT['rnm-button-4']); ?>" class="login" type="submit" /> </td>
					</tr>
				</tbody>
			</table>
		</form>
