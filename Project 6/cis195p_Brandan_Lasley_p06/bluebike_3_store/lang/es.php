<?php
	...
	$TEXT ['rnm-head'] = "<<< BlueBike Catálogo >>>"; 
	$TEXT ['rnm-col-1'] = "Hacer"; 
	$TEXT ['rnm-col-2'] = "Modelo"; 
	$TEXT ['rnm-col-3'] = "Año"; 
	$TEXT ['rnm-col-4'] = "Tamaño"; 
	$TEXT ['rnm-col-5'] = "Tipo"; 
	$TEXT ['rnm-col-6'] = "Cambio"; 

	$TEXT ['?-rnm ok'] = "¿Realmente OK para borrar?"; 
	$TEXT ['rnm-cabeza-1'] = "Añadir Bike"; 
	$TEXT ['rnm-button-1'] = "BORRAR"; 
	$TEXT ['rnm-button-2'] = "Añadir Bike"; 
	$TEXT ['rnm-button-3'] = "BICICLETAS";
	...
	$TEXT['rnm-as-pdf'] = "bici azul catálogo en
