<?php
	...
	// BlueBike  Media
	// ---------------------------------------------------------------------
	$TEXT['rnm-head'] = "<<< BlueBike  Katalog >>>";
	$TEXT['rnm-col-1'] = "machen";
	$TEXT['rnm-col-2'] = "Modell";
	$TEXT['rnm-col-3'] = "Jahr";
	$TEXT['rnm-col-4'] = "Größe";
	$TEXT['rnm-col-5'] = "Typ";
	$TEXT['rnm-col-6'] = "Rate";

	$TEXT['rnm-ok?'] = "Wirklich sicher?";
	$TEXT['rnm-head-1'] = "CD Fahrrad";
	$TEXT['rnm-button-1'] = "CD LÖSCHEN" ;
	$TEXT['rnm-button-2'] = "CD Fahrrad";
	$TEXT['rnm-button-3'] = "Fahrrad";
	...
	$TEXT['rnm-as-pdf'] = " BlueBike  katalog als
