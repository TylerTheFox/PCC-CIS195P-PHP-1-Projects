...
<body>
	<div>
		<h1 id="title">bluebike <?PHP
echo ($TEXT['rnm-reg-txt-8']);
?></h1>
	</div>
...
?></td><td >
			...
			<tr ><td >&nbsp;<?PHP
echo ($TEXT['rnm-reg-txt-2']);
?></td><td >
				<input type='password' name='password2'>
			</td></tr>
			<tr ><td >&nbsp;<?PHP
echo ($TEXT['rnm-reg-txt-3']);
?></td><td >
				<input type='password' name='password3'>
			</td></tr>
			<tr><td>&nbsp;<?PHP
echo ($TEXT['rnm-reg-txt-4']);
?></td><td>
				<input type='text' name='email'>
			</td></tr>
			<tr><td>&nbsp;<?PHP
echo ($TEXT['rnm-reg-txt-5']);
?></td><td>
				<input type='text' name='name'>
			</td></tr>
			<tr><td>&nbsp;<?PHP
echo ($TEXT['rnm-reg-txt-6']);
?></td><td>
				<input type='radio' value='male' checked name='sex'><?PHP
echo ($TEXT['rnm-radio-0']);
?>
				<input type='radio' value='female'	name='sex'><?PHP
echo ($TEXT['rnm-radio-1']);
?>
			</td></tr>
			<tr ><td >&nbsp;<?PHP
echo ($TEXT['rnm-reg-txt-7']);
?></td><td >
				<input type='checkbox' name='iagree' value='yes'>
			</td></tr>
			<tr><td align='center' colspan='2'><br />
				<input type='submit' value='Signup'><br /><br /><a href='login.php'><?PHP
echo ($TEXT['rnm-reg-txt-9']);
?></a>
			</td></tr>
		</table>
            </form>
